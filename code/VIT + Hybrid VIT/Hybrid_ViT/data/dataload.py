...
class VITSet():
    ...
    def setup(self, stage=None):
        if stage == 'fit' or stage is None:
            self.trainset = Bitmoji(root=r'C:\Users\lenovo\Desktop\Bitmoji_Hybrid_ViT-main\Hybrid_ViT_normal\data\Bitmojidata', train=True, args=self.args)
            self.valset = Bitmoji(root=r'C:\Users\lenovo\Desktop\Bitmoji_Hybrid_ViT-main\Hybrid_ViT_normal\data\Bitmojidata', train=False, args=self.args)
            self.testset = Bitmoji(root=r'C:\Users\lenovo\Desktop\Bitmoji_Hybrid_ViT-main\Hybrid_ViT_normal\data\Bitmojidata', test=True, args=self.args)
        else:
